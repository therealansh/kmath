...
public open class ComplexGroupND<T, out A>(
    shape: IntArray,
    elementContext: A,
...
public fun <T, A> BufferedGroupND<T, A>.complex(): ComplexGroupND<T, A> where A : Group<T>, A : NumericAlgebra<T> =
    ComplexGroupND(shape, elementContext, bufferFactory)


public open class ComplexRingND<T, out A>(
    shape: IntArray,
    elementContext: A,
    bufferFactory: BufferFactory<T>,
...
public fun <T, A> BufferedRingND<T, A>.complex(): ComplexRingND<T, A> where A : Ring<T>, A : NumericAlgebra<T> =
    ComplexRingND(shape, elementContext, bufferFactory)


public open class ComplexFieldND<T, out A>(
    shape: IntArray,
    elementContext: A,
    bufferFactory: BufferFactory<T>,
...
public fun <T, A> BufferedFieldND<T, A>.complex(): ComplexFieldND<T, A> where A : Field<T>, A : NumericAlgebra<T> =
    ComplexFieldND(shape, elementContext, bufferFactory)

public open class ComplexExtendedFieldND<T, out A>(
    shape: IntArray,
    elementContext: A,
    bufferFactory: BufferFactory<T>,
...
public fun <T, A> BufferedExtendedFieldND<T, A>.complex(): ComplexExtendedFieldND<T, A> where A : ExtendedField<T>, A : NumericAlgebra<T> =
